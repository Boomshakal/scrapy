...
class MeishiSpider(scrapy.Spider):
    ...
    offset = 0
    # areaList = [{"id": 28, "name": "福田区", "count": 3878}, {"id": 29, "name": "罗湖区", "count": 1931},
    #             {"id": 30, "name": "南山区", "count": 4038}, {"id": 32, "name": "宝安区", "count": 5344},
    #             {"id": 33, "name": "龙岗区", "count": 4440}, {"id": 9553, "name": "龙华区", "count": 3344},
    #             {"id": 31, "name": "盐田区", "count": 368}, {"id": 9535, "name": "南澳大鹏新区", "count": 79},
    #             {"id": 23420, "name": "坪山区", "count": 345}]
    ...
    def before_request(self, areaId, offset):
        parms = {
            ...
            'offset': '15',
            'optimusCode': '10',
            'originUrl': "http://meishi.meituan.com/i/?ci=57&stid_b=1&cevent=imt%2Fhomepage%2Fcategory1%2F1",
            'partner': '126',
            'platform': '3',
            'poi_attr_20033': "",
            'poi_attr_20043': "",
            ...
            'sort': "default",
            'stationId': '0',
            'uuid':'a6bda921-a8f3-41a1-b2b6-338f7330c021' ,
            'version': "8.3.3",
        }
        return scrapy.FormRequest(url=self.url, method='POST', formdata=parms, callback=self.parse, dont_filter=True,
                                  meta={'areaId': areaId,
                                        'offset': offset, })  # FormRequest注意formdata的字典中不能用int,需要转换成str
        # 方法二
